...
def populate_manually():
    ...
    table_descr = [
        ...
        '53,-,R2,100,Socher,AN_NN,-,0,1,0,SignifiedOnlyFeatureHandler',
        '54,-,MR,100,Socher,AN_NN,-,0,1,0,SignifiedOnlyFeatureHandler',
        ...
        '103,-,R2,100,Socher,AN_NN,-,0,0,0,SignifiedOnlyFeatureHandler',
        '104,-,MR,100,Socher,AN_NN,-,0,0,0,SignifiedOnlyFeatureHandler',
        ...
        '112,-,R2,100,Socher,AN,-,0,1,0,SignifiedOnlyFeatureHandler',
        ...
        '120,-,R2,100,Socher,NN,-,0,1,0,SignifiedOnlyFeatureHandler',
    ]
